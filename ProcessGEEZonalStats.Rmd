...
AIM_wGEE_wrk <- AIM_wGEE %>%
  separate(geometry,c("xtest", "ytest"), sep = ',') 

View(AIM_wGEE_wrk)

AIM_wGEE_x <- as_tibble(str_remove_all(string = AIM_wGEE_wrk$xtest, pattern = "[c(]")) 
AIM_wGEE_y <- as_tibble(str_remove_all(string = AIM_wGEE_wrk$ytest, pattern = "[)]"))

AIM_wGEE_wrk <- cbind(AIM_wGEE_wrk,as.numeric(AIM_wGEE_x))
View(AIM_tib)
AIM_tib = AIM_wGEE_wrk %>%
  as_tibble() %>%
  select(xtest)
...
View(test)
View(AIM_wGEE)
AIM_wGEEspatial <- st_as_sf(AIM_wGEE, coords = geometry)
